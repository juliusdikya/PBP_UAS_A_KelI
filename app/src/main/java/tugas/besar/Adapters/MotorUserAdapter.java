...
public class MotorUserAdapter extends RecyclerView.Adapter<MotorUserAdapter.RoomViewHolder> implements Filterable {
    private List<MotorDAO> dataList;
    private List<MotorDAO> filteredDataList;
    private Context context;

    public MotorUserAdapter(Context context, List<MotorDAO> dataList){
    ...
    @Override
    public void onBindViewHolder(@NonNull MotorUserAdapter.RoomViewHolder holder, int position) {
